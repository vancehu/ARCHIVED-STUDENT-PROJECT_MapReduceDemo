...
public class SegmentIndexing {
    static long width = 11916500;
    static long height = 14137000;
    static long gridWidth = 500000;
    static long gridHeight = 500000;
    static int maxCol = (int) Math.ceil(width / gridWidth);
    static int maxRow = (int) Math.ceil(height / gridHeight);
